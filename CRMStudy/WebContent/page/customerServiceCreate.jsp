   ...
   <form id="fm" method="post">
	<table cellspacing="8px">
 		<tr>
 			...
 			<td>客户：</td>
 			<td>
 				<input type="hidden" id="state" name="state" value="新创建"/>
 				<input type="text" id="customer" name="customer" class="easyui-validatebox" required="true"/><font color="red">*</font></td>
 		</tr>
 		<tr>
 			<td>概要：</td>
 			<td colspan="4">
